                                    ...
                                    <tbody>
                                        @foreach ($Product->ProductColors as $procolor)
                                            <tr class="prod-color-tr">
                                                ...
                                                <td>
                                                    <button type="button" value="{{ $procolor->id }}"
                                                        class="deleteproductcolorbtnBtn btn btn-danger btn-sm text-white">delete</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        {{-- @foreach ($Product->ProductColors as $procolor)
                                            updateproductcolorBtn
                                            <tr class="prod-color-tr">
                                                ...
                                                <td>
                                                    <div class="input-group mb-3" style="width: 150px;">
                                                        ...
                                                        productcolorquantity productcolorquantity productcolorquantity productcolorquantity
                                                            class="productcolorquantity form-control form-control-sm ">
                                                        <button type="button" value="{{ $procolor->id }}"
                                                            class="updateproductcolorBtn btn btn-success btn-sm text-white">udate</button>
                                                    </div>
                                                ...
                                                <td>
                                                    <button type="button" value="{{ $procolor->id }}"
                                                        class="deleteproductcolorbtnBtn btn-danger btn-sm text-white">delete</button>
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.deleteproductcolorbtnBtn', function() {
                var prod_color_id = $(this).val();
                var thisClick = $(this);
